...
uReg is an easy to use plugin for [uMMORPG](https://www.assetstore.unity3d.com/en/#!/content/51212) framework that helps to easily handle user registration and authentication using a Flat File approach. 
